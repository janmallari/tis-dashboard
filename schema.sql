...
--
-- Name: agency_user_role; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: agency_is_active_or_onboarding(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.agency_is_active_or_onboarding(p_agency_id bigint) RETURNS boolean
...
--
-- Name: agency_is_active_or_onboarding_no_rls(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.agency_is_active_or_onboarding_no_rls(p_agency_id bigint) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  _r boolean;
...
--
-- Name: create_agency_with_admin(text, text, uuid, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.create_agency_with_admin(agency_name text, slug text, created_by uuid, admin_name text, admin_email text) RETURNS json
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: disable_integration(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.disable_integration(p_integration_id uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: get_active_integration(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_active_integration(p_agency_id bigint) RETURNS TABLE(id uuid, provider text, access_token text, refresh_token text, expires_at timestamp with time zone, status public.integration_status)
    LANGUAGE sql SECURITY DEFINER
    AS $$
...
--
-- Name: get_agency_users(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_agency_users(agency_id bigint) RETURNS TABLE(id uuid, full_name text, email text, role public.agency_user_role, is_active boolean)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: get_user_agencies(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_user_agencies(user_id uuid) RETURNS TABLE(agency_id bigint, agency_name text, user_role public.agency_user_role)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: is_agency_admin(uuid, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_agency_admin(user_id uuid, agency_id bigint) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN EXISTS (
...
--
-- Name: is_super_admin_no_rls(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_super_admin_no_rls(p_user uuid) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  _r boolean;
...
--
-- Name: remove_integration(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.remove_integration(p_integration_id uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
  UPDATE public.storage_integrations
...
--
-- Name: set_agency_status(bigint, public.agency_status); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_agency_status(target_agency_id bigint, new_status public.agency_status) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: update_storage_integrations_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_storage_integrations_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
--
-- Name: user_in_agency_active_or_onboarding(uuid, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.user_in_agency_active_or_onboarding(p_user uuid, p_agency_id bigint) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: user_in_agency_active_or_onboarding_no_rls(uuid, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.user_in_agency_active_or_onboarding_no_rls(p_user uuid, p_agency_id bigint) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  _r boolean;
...
--
-- Name: user_is_agency_admin(uuid, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.user_is_agency_admin(check_user_id uuid, check_agency_id bigint) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  RETURN EXISTS (
...
--
-- Name: user_is_agency_admin_no_rls(uuid, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.user_is_agency_admin_no_rls(p_user uuid, p_agency_id bigint) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  _r boolean;
...
--
-- Name: agency_invitation_logs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.agency_invitation_logs (
    id bigint NOT NULL,
...
--
-- Name: agency_invitation_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.agency_invitation_logs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: agency_invitation_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: storage_integrations; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: agency_invitation_logs id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: agency_invitation_logs agency_invitation_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: agency_users agency_users_agency_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: storage_integrations storage_integrations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_agencies_created_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_agency_invitation_logs_agency; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_agency_invitation_logs_invited_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_agency_users_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_agency_users_agency; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_agency_users_role; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_agency_users_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: agency_users update_agency_users_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: storage_integrations update_storage_integrations_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_storage_integrations_updated_at BEFORE UPDATE ON public.storage_integrations FOR EACH ROW EXECUTE FUNCTION public.update_storage_integrations_updated_at();
...
--
-- Name: agencies agencies_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: agency_invitation_logs agency_invitation_logs_agency_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: agency_invitation_logs agency_invitation_logs_invited_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: agency_invitation_logs agency_invitation_logs_invited_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: agency_users agency_users_invited_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: storage_integrations storage_integrations_agency_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: agency_invitation_logs Agency admins can view logs for their agencies; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: storage_integrations Agency admins manage storage integrations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: agency_invitation_logs Super admins can view all invitation logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_profiles Super admins can view all profiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: agencies agencies_delete_admin_only_when_open; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agencies_delete_admin_only_when_open ON public.agencies FOR DELETE USING (((public.user_is_agency_admin_no_rls(auth.uid(), id) AND public.agency_is_active_or_onboarding_no_rls(id)) OR public.is_super_admin_no_rls(auth.uid())));


--
-- Name: agencies agencies_insert_super_admin_only; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agencies_insert_super_admin_only ON public.agencies FOR INSERT WITH CHECK (public.is_super_admin_no_rls(auth.uid()));


--
-- Name: agencies agencies_select_own_active_or_onboarding; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agencies_select_own_active_or_onboarding ON public.agencies FOR SELECT USING ((public.user_in_agency_active_or_onboarding_no_rls(auth.uid(), id) OR public.is_super_admin_no_rls(auth.uid())));


--
-- Name: agencies agencies_update_admin_only_when_open; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agencies_update_admin_only_when_open ON public.agencies FOR UPDATE USING (((public.user_is_agency_admin_no_rls(auth.uid(), id) AND public.agency_is_active_or_onboarding_no_rls(id)) OR public.is_super_admin_no_rls(auth.uid())));


--
-- Name: agency_invitation_logs; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: agency_users agency_users_delete_admin_only_when_open; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agency_users_delete_admin_only_when_open ON public.agency_users FOR DELETE USING (((public.user_is_agency_admin_no_rls(auth.uid(), agency_id) AND public.agency_is_active_or_onboarding_no_rls(agency_id)) OR public.is_super_admin_no_rls(auth.uid())));


--
-- Name: agency_users agency_users_insert_admin_only_when_open; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agency_users_insert_admin_only_when_open ON public.agency_users FOR INSERT WITH CHECK (((public.user_is_agency_admin_no_rls(auth.uid(), agency_id) AND public.agency_is_active_or_onboarding_no_rls(agency_id)) OR public.is_super_admin_no_rls(auth.uid())));


--
-- Name: agency_users agency_users_select_self_when_open; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agency_users_select_self_when_open ON public.agency_users FOR SELECT USING ((((user_id = auth.uid()) AND public.agency_is_active_or_onboarding_no_rls(agency_id)) OR public.user_is_agency_admin_no_rls(auth.uid(), agency_id) OR public.is_super_admin_no_rls(auth.uid())));


--
-- Name: agency_users agency_users_update_admin_only_when_open; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY agency_users_update_admin_only_when_open ON public.agency_users FOR UPDATE USING (((public.user_is_agency_admin_no_rls(auth.uid(), agency_id) AND public.agency_is_active_or_onboarding_no_rls(agency_id)) OR public.is_super_admin_no_rls(auth.uid())));


--
-- Name: storage_integrations; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION agency_is_active_or_onboarding(p_agency_id bigint); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION agency_is_active_or_onboarding_no_rls(p_agency_id bigint); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.agency_is_active_or_onboarding_no_rls(p_agency_id bigint) TO anon;
GRANT ALL ON FUNCTION public.agency_is_active_or_onboarding_no_rls(p_agency_id bigint) TO authenticated;
GRANT ALL ON FUNCTION public.agency_is_active_or_onboarding_no_rls(p_agency_id bigint) TO service_role;


--
-- Name: FUNCTION create_agency_with_admin(agency_name text, slug text, created_by uuid, admin_name text, admin_email text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION disable_integration(p_integration_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_active_integration(p_agency_id bigint); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_agency_users(agency_id bigint); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_user_agencies(user_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_agency_admin(user_id uuid, agency_id bigint); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_super_admin_no_rls(p_user uuid); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.is_super_admin_no_rls(p_user uuid) TO anon;
GRANT ALL ON FUNCTION public.is_super_admin_no_rls(p_user uuid) TO authenticated;
GRANT ALL ON FUNCTION public.is_super_admin_no_rls(p_user uuid) TO service_role;


--
-- Name: FUNCTION remove_integration(p_integration_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION set_agency_status(target_agency_id bigint, new_status public.agency_status); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION update_storage_integrations_updated_at(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION user_in_agency_active_or_onboarding(p_user uuid, p_agency_id bigint); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION user_in_agency_active_or_onboarding_no_rls(p_user uuid, p_agency_id bigint); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.user_in_agency_active_or_onboarding_no_rls(p_user uuid, p_agency_id bigint) TO anon;
GRANT ALL ON FUNCTION public.user_in_agency_active_or_onboarding_no_rls(p_user uuid, p_agency_id bigint) TO authenticated;
GRANT ALL ON FUNCTION public.user_in_agency_active_or_onboarding_no_rls(p_user uuid, p_agency_id bigint) TO service_role;


--
-- Name: FUNCTION user_is_agency_admin(check_user_id uuid, check_agency_id bigint); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION user_is_agency_admin_no_rls(p_user uuid, p_agency_id bigint); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.user_is_agency_admin_no_rls(p_user uuid, p_agency_id bigint) TO anon;
GRANT ALL ON FUNCTION public.user_is_agency_admin_no_rls(p_user uuid, p_agency_id bigint) TO authenticated;
GRANT ALL ON FUNCTION public.user_is_agency_admin_no_rls(p_user uuid, p_agency_id bigint) TO service_role;
...
--
-- Name: SEQUENCE agencies_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agency_invitation_logs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE agency_invitation_logs_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE agency_users; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE agency_users_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE storage_integrations; Type: ACL; Schema: public; Owner: -
--
